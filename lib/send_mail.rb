...
def send_match_notifications(current_trip, matched_trips)
  if !matched_trips.empty?
    response_email = "Hello #{current_trip.name},\n\nGreetings from shareMyCab! Here are some other people travelling to destinations around you on #{current_trip.arrival_datetime}:\n"
    ...
    Net::SMTP.start('smtp.gmail.com', 587, 'gmail.com', 'services@vacationlabs.com', settings.mail_password, :login) do |smtp|
